function getContactData(){var destination=settings.get("destination");$.getJSON("api/contact/destination/"+encodeURIComponent(destination),function(data){settings.set("contact",data.contact),settings.set("contactPhone",data.contactPhone),settings.set("rep",data.rep),settings.set("repPhone",data.repPhone)}).done(function(){window.location.href="list.php"})}function getReports(){reports.removeAll();var trip=settings.get("tripNum");$.get("api/reports/"+trip,function(data){var parsed=jQuery.parseJSON(data);jQuery.each(parsed,function(key,value){reports.set(key,value)})}).done(function(){outputReports()})}function getTripData(){{var trip=settings.get("tripNum"),statuses=settings.get("status"),bus=settings.get("bus");settings.get("destination")}orders.removeAll(),initialHTML.removeAll(),tripData.removeAll(),newWalkon.removeAll(),messages.removeAll(),$.get("api/trip/"+trip+"/"+bus+"/"+statuses,function(data){var apiData=jQuery.parseJSON(data);console.log(apiData),apiData&&jQuery.each(apiData,function(id,dataObject){jQuery.each(dataObject,function(key,value){"Data"==key?(orders.set(id,value),"Pickup"in value&&settings.set("Pickup",1)):"HTML"==key?initialHTML.set(id,value):"State"==key&&null!==value&&tripData.set(id+":"+value,1)})})}).done(function(){getContactData()})}function onlineReportSave(report,bus,trip){$.post("api/report/add",{bus:bus,tripId:trip,report:report},function(data){"success"!=data&&alert("Report Save failed")})}function saveOfflineReports(){jQuery.each(unsavedReports.keys(),function(key,value){var report=unsavedReports.get(value);report=report.split("#!");var bus=report[0];report=report[1],onlineReportSave(report,bus,settings.get("tripNum"))}),window.unsavedReports.removeAll(),window.savingReports=!1,alert("saved offline report(s)")}function toggleMenuButtons(onlineOffline){var buttons=["#btn-settings","#saveList","#btn-message","#btn-admin","#btn-logout","#refreshReports"];if("offline"==onlineOffline)jQuery.each(buttons,function(key,value){$(value).hasClass("disabled")||$(value).addClass("disabled")});else{var currentPage=location.pathname.split("/").slice(-1)[0];currentPage=currentPage.split("."),currentPage=currentPage[0],jQuery.each(buttons,function(key,value){$(value).hasClass("disabled")&&($(value).removeClass("disabled"),("#btn-settings"==value&&("index"==currentPage||""===currentPage)||"#btn-message"==value&&"message"==currentPage||"#btn-admin"==value&&"admin"==currentPage)&&$(value).addClass("disabled"))})}}function bounceToIndex(){var bounce=!1;switch(window.location.pathname){case"/":bounce=!1;break;case"/index.php":bounce=!1;break;case"/list.php":bounce=!0;break;case"/summary.php":bounce=!0;break;case"/reports.php":bounce=!0;break;case"/message.php":bounce=!0;break;case"/login/index.php":bounce=!1;break;case"/login/logout.php":bounce=!1;break;default:bounce=!1}bounce&&settings.isEmpty()&&(alert("Please select a trip first"),window.location.href="index.php")}function addWalkonButton(){var walkonPackage=$("#walkonPackage").val();if("Other"==walkonPackage&&void 0===$("#otherPackage").val()){var html="<div id='otherDiv'><input id='otherPackage' type='text' class='input-sm' placeholder='Input Package'></input><br /><br /></div>";$(html).insertBefore("#saveWalkOn"),$("#otherPackage").on("keyup",function(){addWalkonButton()})}else"Other"!==walkonPackage&&void 0!==$("#otherPackage").val()&&($("#otherPackage").unbind("keyup"),$("#otherDiv").remove());var pickup,first=$("#first").val(),last=$("#last").val(),phone=$("#phone").val(),otherPackage=$("#otherPackage").val();pickup=settings.isSet("Pickup")?$("#pickup").val():"none",""!==first&&""!==last&&""!==phone&&""!==pickup&&("Other"==walkonPackage&&""!==otherPackage&&void 0!==otherPackage||"Other"!==walkonPackage&&"none"!==walkonPackage)?$("#saveWalkOn").removeClass("disabled"):$("#saveWalkon").hasClass("disabled")||$("#saveWalkOn").addClass("disabled")}function changeStatus(element){if(!element.hasClass("bg-noshow")){if("PM"==$("#AMPM").val()){var foundClass=!1;if(element.hasClass("bg-am")&&(element.removeClass("bg-am"),foundClass=!0),element.hasClass("bg-waiver")&&(element.removeClass("bg-waiver"),foundClass=!0),element.hasClass("bg-productrec")&&(element.removeClass("bg-productrec"),foundClass=!0),foundClass){element.addClass("bg-pm"),element.find("span.icon").html('<i class="fa fa-moon-o fa-lg"></i>'),element.find(".flexPackage").addClass("visible-md visible-lg"),element.find(".flexPickup").removeClass("visible-md visible-lg");var PM=element.attr("id")+":PM";tripData.set(PM,1)}}if(element.hasClass("bg-none")){var AM=element.attr("id")+":AM",Delete=element.attr("id")+":Delete",Bus=element.attr("id")+":Bus";tripData.set(AM,1),tripData.remove(Delete),tripData.set(Bus,settings.get("bus")),element.removeClass("bg-none"),element.addClass("bg-am"),element.find("span.icon").html('<i class="fa fa-sun-o fa-lg"></i>'),element.find(".flexPackage").removeClass("visible-md visible-lg"),element.find(".flexPickup").addClass("visible-md visible-lg")}else if(element.hasClass("bg-am")){var Waiver=element.attr("id")+":Waiver";tripData.set(Waiver,1),element.removeClass("bg-am"),element.addClass("bg-waiver"),element.find("span.icon").html('<i class="fa fa-file-word-o fa-lg"></i>')}else if(element.hasClass("bg-waiver")){var Product=element.attr("id")+":Product";tripData.set(Product,1),element.removeClass("bg-waiver"),element.addClass("bg-productrec"),element.find("span.icon").html('<i class="fa fa-ticket fa-lg"></i>'),element.find(".flexPackage").addClass("visible-md visible-lg"),element.find(".flexPickup").removeClass("visible-md visible-lg")}}}function checkData(){var localData={},states={AM:1,BUS:0,Waiver:2,Product:3,PM:4};jQuery.isEmptyObject(tripData)||(jQuery.each(tripData.keys(),function(key,value){var split=value.split(":"),ID=split[0]+":"+split[1];jQuery.isEmptyObject(localData[ID])?localData[ID]=split[2]:states[localData[ID]]<states[split[2]]&&(localData[ID]=split[2])}),jQuery.each(localData,function(key,value){var selector=key.split(":");setState($("#"+selector[0]+"\\:"+selector[1]),value)}))}function getPackages(){var packages={};jQuery.each(orders.keys(),function(key,value){var order=orders.get(value);packages[order.Package]=order.Package});var output="<option value='none'>Package</option>";jQuery.each(packages,function(key,value){var row="<option value='"+value+"'>"+value+"</option>";output=output.concat(row)}),$("select.packageList").append(output)}function getPickups(){var pickups={};jQuery.each(orders.keys(),function(key,value){var order=orders.get(value);pickups[order.Pickup]=order.Pickup});var output="<option value='none'>Pickup</option>";jQuery.each(pickups,function(key,value){var row="<option value='"+value+"'>"+value+"</option>";output=output.concat(row)}),$("select.pickupList").append(output)}function listHTML(ID,order){var split=ID.split(":"),output="<div class='row listButton bg-none' id='"+ID+"'>                      <div class='row primary'>                          <div class='buttonCell name col-xs-7 col-md-4'>                              <span class='icon'></span>                              <span class='first'>&nbsp;"+order.First+"</span>                              <span class='last'>"+order.Last+"</span>                          </div>                          <div class='noClick buttonCell col-md-2 visible-md visible-lg'>                            Order: <span class='orderNum'>"+split[0]+"</span></div>";if(settings.isSet("Pickup")){var pickupHTML='<div class="buttonCell col-xs-5 col-md-3 flexPickup">'+order.Pickup+"</div>";output=output.concat(pickupHTML)}var packageHTML="<div class='buttonCell col-xs-5 col-md-3 flexPackage visible-md visible-lg'>                        "+order.Package+"</div>                    </div>                    <div class='expanded'>                        <div class='row'>                            <div class='buttonCell col-xs-5 col-md-6'>                            <strong>Package:</strong> "+order.Package+"</div>";if(output=output.concat(packageHTML),settings.isSet("Pickup")){var packageHTML2="<div class='buttonCell col-xs-12 col-md-6'>                            <strong>Pickup:</strong> "+order.Pickup+"</div>";output=output.concat(packageHTML2)}var expandedRemainder="</div>                <div class='row'>                    <div class='buttonCell col-xs-12 col-md-6'>                        <strong>Order:</strong>"+split[0]+" </div>                    <div class='buttonCell col-xs-12 col-md-6'>                    <strong>Phone:</strong> <a href='tel:"+order.Phone+"'><span class='phone'>"+order.Phone+"</span></a>                 </div>              </div>              <div class='row'>                <br />                <div class='buttonCell col-xs-4'>                    <button class='btn btn-info' id='"+ID+":Reset'>                        Reset                    </button>                </div>                <div class='buttonCell col-xs-4'>                    <button class='btn btn-warning' id='"+ID+":NoShow'>                        No Show                    </button>                </div>";"WO"==ID.substring(0,2)&&(expandedRemainder=expandedRemainder.concat('<div class="buttonCell col-xs-4"><button class="btn btn-danger" id="'+ID+':Delete">Remove Order</button></div>')),expandedRemainder=expandedRemainder.concat("</div></div></div>"),output=output.concat(expandedRemainder),$("#content").append(output),initialHTML.set(ID,output),setupListener(ID),$("div.expanded").hide()}function noShow(element){var NoShow=element.attr("id")+":NoShow";tripData.set(NoShow,1),element.addClass("bg-noshow"),element.find("span.icon").html('<i class="fa fa-exclamation-triangle fa-lg"></i>')}function packageList(){window.packageList=[];var output="<option value='none' selected>Select Package</option>";jQuery.each(orders.keys(),function(key,value){var currentOrder=orders.get(value);-1==packageList.indexOf(currentOrder.Package)&&packageList.push(currentOrder.Package)}),packageList.push("Other"),jQuery.each(packageList,function(key,value){output=output.concat("<option value='"+value+"'>"+value+"</option>")}),dd.set("packages",output)}function pageTotal(){var totalGuests=$("div.listButton:visible").length;$("span.listTotal").text(totalGuests+" Guests")}function resetGuest(element){var ID=element.attr("id"),clearVars=[ID+":AM",ID+":PM",ID+":Waiver",ID+":Product",ID+":NoShow",ID+":Bus"];element.removeClass(),element.addClass("row listButton bg-none"),element.find("span.icon").html(""),jQuery.each(clearVars,function(key,value){tripData.remove(value)}),tripData.set(ID+":Delete",1)}function saveData(){var packageWeight={AM:1,Waiver:2,Product:3,PM:4,NoShow:5,Delete:6},allDataKeys=tripData.keys(),orderLocalData={};if(jQuery.each(allDataKeys,function(key,value){var split=value.split(":"),ID=split[0]+":"+split[1],valueName=split[2];"WO"==value.substring(0,2)&&"Delete"==valueName&&"Delete"==tripData.get(value)&&$.post("api/walkon/delete/"+ID),jQuery.isEmptyObject(orderLocalData[ID])&&(orderLocalData[ID]={Trip:settings.get("tripNum"),Bus:settings.get("bus"),Data:""}),(""===orderLocalData[ID].Data||packageWeight[valueName]>packageWeight[orderLocalData[ID].Data])&&(orderLocalData[ID].Data=valueName)}),newWalkon.keys().length>0){var walkonData={};jQuery.each(newWalkon.keys(),function(key,value){walkonData[value]=orders.get(value),walkonData[value].Bus=settings.get("bus"),walkonData[value].Trip=settings.get("tripNum")}),$.post("api/save/walkon",{walkon:walkonData},function(){newWalkon.removeAll()})}tripData.isEmpty()||$.post("api/save/data",{data:orderLocalData},function(){tripData.removeAll(),getTripData()})}function saveWalkOn(){var walkonPackage=$("#walkonPackage");walkonPackage="Other"==walkonPackage.val()?$("#otherPackage").val():walkonPackage.val();var orderNum=Math.floor(99999*Math.random()+1);orderNum="WO"+String(orderNum.pad(4));var orderItem=Math.floor(99999*Math.random()+1);orderItem=orderItem.pad(4);var ID=orderNum+":"+orderItem,walkOn={First:$("#first").val(),Last:$("#last").val(),Phone:$("#phone").val(),Package:walkonPackage};settings.isSet("Pickup")&&(walkOn.Pickup=$("#pickup").val()),listHTML(ID,walkOn),orders.set(ID,walkOn),newWalkon.set(ID,"unsaved"),$("#addWalkOn").popover("toggle")}function searchList(searchType,text){var search;""!==text?("Name"==searchType?search=$(".listButton div.name:contains('"+text+"')"):"Email"==searchType?search=$(".listButton span.email:contains('"+text+"')"):"Phone"==searchType?search=$(".listButton span.phone:contains('"+text+"')"):"Order"==searchType?search=$(".listButton span.orderNum:contains('"+text+"')"):"Package"==searchType&&(search=$(".listButton div.flexPackage:contains('"+text+"')")),showSearchResults(search)):$(".listButton").show()}function setState(element,state){"AM"==state?(element.removeClass(),element.addClass("row listButton bg-am"),element.find("span.icon").html('<i class="fa fa-sun-o fa-lg"></i>'),element.removeClass("bg-none")):"Waiver"==state?(element.removeClass(),element.addClass("row listButton bg-waiver"),element.find("span.icon").html('<i class="fa fa-file-word-o fa-lg"></i>'),element.removeClass("bg-none")):"Product"==state?(element.removeClass(),element.addClass("row listButton bg-productrec"),element.find("span.icon").html('<i class="fa fa-ticket fa-lg"></i>'),element.removeClass("bg-none")):"PM"==state?(element.removeClass(),element.addClass("row listButton bg-pm"),element.find("span.icon").html('<i class="fa fa-moon-o fa-lg"></i>'),element.find(".flexPackage").addClass("visible-md visible-lg"),element.find(".flexPickup").removeClass("visible-md visible-lg"),element.removeClass("bg-none")):"NoShow"==state&&noShow(element)}function setupAllListeners(){jQuery.each(orders.keys(),function(key,value){setupListener(value)})}function setupListener(ID){var split=ID.split(":"),selectorID="#"+split[0]+"\\:"+split[1];"WO"==ID.substring(0,2)&&$(selectorID+"\\:Delete").click(function(){tripData.set(split[0]+":"+split[1]+":Delete","Delete"),$(this).parents(".listButton").remove()}),$(selectorID+"\\:Reset").click(function(){resetGuest($(this).parents().eq(3))}),$(selectorID+"\\:NoShow").click(function(){noShow($(this).parents().eq(3))}),$(selectorID).on("doubletap",function(){toggleExpanded($(this))}),"All"!=settings.get("bus")&&$("#"+split[0]+"\\:"+split[1]+" div.row.primary").on("singletap",function(){changeStatus($(this).parent()),console.log($(this).attr("id")),console.log($(this)),console.log("clicked")})}function setupPage(){settings.isSet("tripName")&&$("#tripName").text(settings.get("tripName")),settings.isSet("bus")&&$("#bus").text(settings.get("bus")),settings.isSet("destination")&&$("#destName").text(settings.get("destination"));var keys=initialHTML.keys();jQuery.each(keys,function(key,value){$("#content").append(initialHTML.get(value))}),settings.isSet("Pickup")?(getPickups(),$("select.pickupList").on("change",function(){$("select.packageList").val("none"),$("div.listButton").show();var value=$(this).val();if("none"!==value){var selector="div.listButton:not(:contains('"+value+"'))";$(selector).hide()}pageTotal()})):$("select.pickupList").hide(),getPackages(),$("select.packageList").on("change",function(){$("select.pickupList").val("none"),$("div.listButton").show();var value=$(this).val();if("none"!==value){var selector="div.listButton:not(:contains('"+value+"'))";$(selector).hide()}pageTotal()}),$("div.expanded").hide(),sortList()}function showSearchResults(targets){$(".listButton").hide(),targets.parents(".listButton").show()}function sortList(value){switch(value){case"Faz":$(".listButton").tsort("span.first",{order:"asc"});break;case"Fza":$(".listButton").tsort("span.first",{order:"desc"});break;case"Laz":$(".listButton").tsort("span.last",{order:"asc"});break;case"Lza":$(".listButton").tsort("span.first",{order:"desc"});break;case"Paz":$(".listButton").tsort("div.flexPackage",{order:"asc"});break;case"Pza":$(".listButton").tsort("div.flexPackage",{order:"desc"});break;case"Piaz":$(".listButton").tsort("div.flexPickup",{order:"asc"});break;case"Piza":$(".listButton").tsort("div.flexPickup",{order:"desc"});break;case"Oza":$(".listButton").tsort("span.orderNum",{order:"desc"});break;default:$(".listButton").tsort("div.flexPickup","span.last")}}function toggleExpanded(element){element.children("div.expanded").is(":visible")?(element.children("div.expanded").hide(600),"All"!==settings.get("bus")&&element.children("div.row.primary").children().not(".noClick").on("singletap",function(){changeStatus($(this).parents().eq(1))})):(element.children("div.expanded").show(600),element.children("div.row.primary").children().not(".noClick").unbind("singletap"))}if(!function(a,b){"object"==typeof module&&"object"==typeof module.exports?module.exports=a.document?b(a,!0):function(a){if(!a.document)throw new Error("jQuery requires a window with a document");return b(a)}:b(a)}("undefined"!=typeof window?window:this,function(a,b){function r(a){var b=a.length,c=m.type(a);return"function"===c||m.isWindow(a)?!1:1===a.nodeType&&b?!0:"array"===c||0===b||"number"==typeof b&&b>0&&b-1 in a}function w(a,b,c){if(m.isFunction(b))return m.grep(a,function(a,d){return!!b.call(a,d,a)!==c});if(b.nodeType)return m.grep(a,function(a){return a===b!==c});if("string"==typeof b){if(v.test(b))return m.filter(b,a,c);b=m.filter(b,a)}return m.grep(a,function(a){return m.inArray(a,b)>=0!==c})}function D(a,b){do a=a[b];while(a&&1!==a.nodeType);return a}function G(a){var b=F[a]={};return m.each(a.match(E)||[],function(a,c){b[c]=!0}),b}function I(){y.addEventListener?(y.removeEventListener("DOMContentLoaded",J,!1),a.removeEventListener("load",J,!1)):(y.detachEvent("onreadystatechange",J),a.detachEvent("onload",J))}function J(){(y.addEventListener||"load"===event.type||"complete"===y.readyState)&&(I(),m.ready())}function O(a,b,c){if(void 0===c&&1===a.nodeType){var d="data-"+b.replace(N,"-$1").toLowerCase();if(c=a.getAttribute(d),"string"==typeof c){try{c="true"===c?!0:"false"===c?!1:"null"===c?null:+c+""===c?+c:M.test(c)?m.parseJSON(c):c}catch(e){}m.data(a,b,c)}else c=void 0}return c}function P(a){var b;for(b in a)if(("data"!==b||!m.isEmptyObject(a[b]))&&"toJSON"!==b)return!1;return!0}function Q(a,b,d,e){if(m.acceptData(a)){var f,g,h=m.expando,i=a.nodeType,j=i?m.cache:a,k=i?a[h]:a[h]&&h;if(k&&j[k]&&(e||j[k].data)||void 0!==d||"string"!=typeof b)return k||(k=i?a[h]=c.pop()||m.guid++:h),j[k]||(j[k]=i?{}:{toJSON:m.noop}),("object"==typeof b||"function"==typeof b)&&(e?j[k]=m.extend(j[k],b):j[k].data=m.extend(j[k].data,b)),g=j[k],e||(g.data||(g.data={}),g=g.data),void 0!==d&&(g[m.camelCase(b)]=d),"string"==typeof b?(f=g[b],null==f&&(f=g[m.camelCase(b)])):f=g,f}}function R(a,b,c){if(m.acceptData(a)){var d,e,f=a.nodeType,g=f?m.cache:a,h=f?a[m.expando]:m.expando;if(g[h]){if(b&&(d=c?g[h]:g[h].data)){m.isArray(b)?b=b.concat(m.map(b,m.camelCase)):b in d?b=[b]:(b=m.camelCase(b),b=b in d?[b]:b.split(" ")),e=b.length;for(;e--;)delete d[b[e]];if(c?!P(d):!m.isEmptyObject(d))return}(c||(delete g[h].data,P(g[h])))&&(f?m.cleanData([a],!0):k.deleteExpando||g!=g.window?delete g[h]:g[h]=null)}}}function ab(){return!0}function bb(){return!1}function cb(){try{return y.activeElement}catch(a){}}function db(a){var b=eb.split("|"),c=a.createDocumentFragment();if(c.createElement)for(;b.length;)c.createElement(b.pop());return c}function ub(a,b){var c,d,e=0,f=typeof a.getElementsByTagName!==K?a.getElementsByTagName(b||"*"):typeof a.querySelectorAll!==K?a.querySelectorAll(b||"*"):void 0;if(!f)for(f=[],c=a.childNodes||a;null!=(d=c[e]);e++)!b||m.nodeName(d,b)?f.push(d):m.merge(f,ub(d,b));return void 0===b||b&&m.nodeName(a,b)?m.merge([a],f):f}function vb(a){W.test(a.type)&&(a.defaultChecked=a.checked)}function wb(a,b){return m.nodeName(a,"table")&&m.nodeName(11!==b.nodeType?b:b.firstChild,"tr")?a.getElementsByTagName("tbody")[0]||a.appendChild(a.ownerDocument.createElement("tbody")):a}function xb(a){return a.type=(null!==m.find.attr(a,"type"))+"/"+a.type,a}function yb(a){var b=pb.exec(a.type);return b?a.type=b[1]:a.removeAttribute("type"),a}function zb(a,b){for(var c,d=0;null!=(c=a[d]);d++)m._data(c,"globalEval",!b||m._data(b[d],"globalEval"))}function Ab(a,b){if(1===b.nodeType&&m.hasData(a)){var c,d,e,f=m._data(a),g=m._data(b,f),h=f.events;if(h){delete g.handle,g.events={};for(c in h)for(d=0,e=h[c].length;e>d;d++)m.event.add(b,c,h[c][d])}g.data&&(g.data=m.extend({},g.data))}}function Bb(a,b){var c,d,e;if(1===b.nodeType){if(c=b.nodeName.toLowerCase(),!k.noCloneEvent&&b[m.expando]){e=m._data(b);for(d in e.events)m.removeEvent(b,d,e.handle);b.removeAttribute(m.expando)}"script"===c&&b.text!==a.text?(xb(b).text=a.text,yb(b)):"object"===c?(b.parentNode&&(b.outerHTML=a.outerHTML),k.html5Clone&&a.innerHTML&&!m.trim(b.innerHTML)&&(b.innerHTML=a.innerHTML)):"input"===c&&W.test(a.type)?(b.defaultChecked=b.checked=a.checked,b.value!==a.value&&(b.value=a.value)):"option"===c?b.defaultSelected=b.selected=a.defaultSelected:("input"===c||"textarea"===c)&&(b.defaultValue=a.defaultValue)}}function Eb(b,c){var d,e=m(c.createElement(b)).appendTo(c.body),f=a.getDefaultComputedStyle&&(d=a.getDefaultComputedStyle(e[0]))?d.display:m.css(e[0],"display");return e.detach(),f}function Fb(a){var b=y,c=Db[a];return c||(c=Eb(a,b),"none"!==c&&c||(Cb=(Cb||m("<iframe frameborder='0' width='0' height='0'/>")).appendTo(b.documentElement),b=(Cb[0].contentWindow||Cb[0].contentDocument).document,b.write(),b.close(),c=Eb(a,b),Cb.detach()),Db[a]=c),c}function Lb(a,b){return{get:function(){var c=a();return null!=c?c?void delete this.get:(this.get=b).apply(this,arguments):void 0}}}function Ub(a,b){if(b in a)return b;for(var c=b.charAt(0).toUpperCase()+b.slice(1),d=b,e=Tb.length;e--;)if(b=Tb[e]+c,b in a)return b;return d}function Vb(a,b){for(var c,d,e,f=[],g=0,h=a.length;h>g;g++)d=a[g],d.style&&(f[g]=m._data(d,"olddisplay"),c=d.style.display,b?(f[g]||"none"!==c||(d.style.display=""),""===d.style.display&&U(d)&&(f[g]=m._data(d,"olddisplay",Fb(d.nodeName)))):(e=U(d),(c&&"none"!==c||!e)&&m._data(d,"olddisplay",e?c:m.css(d,"display"))));for(g=0;h>g;g++)d=a[g],d.style&&(b&&"none"!==d.style.display&&""!==d.style.display||(d.style.display=b?f[g]||"":"none"));return a}function Wb(a,b,c){var d=Pb.exec(b);return d?Math.max(0,d[1]-(c||0))+(d[2]||"px"):b}function Xb(a,b,c,d,e){for(var f=c===(d?"border":"content")?4:"width"===b?1:0,g=0;4>f;f+=2)"margin"===c&&(g+=m.css(a,c+T[f],!0,e)),d?("content"===c&&(g-=m.css(a,"padding"+T[f],!0,e)),"margin"!==c&&(g-=m.css(a,"border"+T[f]+"Width",!0,e))):(g+=m.css(a,"padding"+T[f],!0,e),"padding"!==c&&(g+=m.css(a,"border"+T[f]+"Width",!0,e)));return g}function Yb(a,b,c){var d=!0,e="width"===b?a.offsetWidth:a.offsetHeight,f=Ib(a),g=k.boxSizing&&"border-box"===m.css(a,"boxSizing",!1,f);if(0>=e||null==e){if(e=Jb(a,b,f),(0>e||null==e)&&(e=a.style[b]),Hb.test(e))return e;d=g&&(k.boxSizingReliable()||e===a.style[b]),e=parseFloat(e)||0}return e+Xb(a,b,c||(g?"border":"content"),d,f)+"px"}function Zb(a,b,c,d,e){return new Zb.prototype.init(a,b,c,d,e)}function fc(){return setTimeout(function(){$b=void 0}),$b=m.now()}function gc(a,b){var c,d={height:a},e=0;for(b=b?1:0;4>e;e+=2-b)c=T[e],d["margin"+c]=d["padding"+c]=a;return b&&(d.opacity=d.width=a),d}function hc(a,b,c){for(var d,e=(ec[b]||[]).concat(ec["*"]),f=0,g=e.length;g>f;f++)if(d=e[f].call(c,b,a))return d}function ic(a,b,c){var d,e,f,g,h,i,j,l,n=this,o={},p=a.style,q=a.nodeType&&U(a),r=m._data(a,"fxshow");c.queue||(h=m._queueHooks(a,"fx"),null==h.unqueued&&(h.unqueued=0,i=h.empty.fire,h.empty.fire=function(){h.unqueued||i()}),h.unqueued++,n.always(function(){n.always(function(){h.unqueued--,m.queue(a,"fx").length||h.empty.fire()})})),1===a.nodeType&&("height"in b||"width"in b)&&(c.overflow=[p.overflow,p.overflowX,p.overflowY],j=m.css(a,"display"),l="none"===j?m._data(a,"olddisplay")||Fb(a.nodeName):j,"inline"===l&&"none"===m.css(a,"float")&&(k.inlineBlockNeedsLayout&&"inline"!==Fb(a.nodeName)?p.zoom=1:p.display="inline-block")),c.overflow&&(p.overflow="hidden",k.shrinkWrapBlocks()||n.always(function(){p.overflow=c.overflow[0],p.overflowX=c.overflow[1],p.overflowY=c.overflow[2]}));for(d in b)if(e=b[d],ac.exec(e)){if(delete b[d],f=f||"toggle"===e,e===(q?"hide":"show")){if("show"!==e||!r||void 0===r[d])continue;q=!0}o[d]=r&&r[d]||m.style(a,d)}else j=void 0;if(m.isEmptyObject(o))"inline"===("none"===j?Fb(a.nodeName):j)&&(p.display=j);else{r?"hidden"in r&&(q=r.hidden):r=m._data(a,"fxshow",{}),f&&(r.hidden=!q),q?m(a).show():n.done(function(){m(a).hide()}),n.done(function(){var b;m._removeData(a,"fxshow");for(b in o)m.style(a,b,o[b])});for(d in o)g=hc(q?r[d]:0,d,n),d in r||(r[d]=g.start,q&&(g.end=g.start,g.start="width"===d||"height"===d?1:0))}}function jc(a,b){var c,d,e,f,g;for(c in a)if(d=m.camelCase(c),e=b[d],f=a[c],m.isArray(f)&&(e=f[1],f=a[c]=f[0]),c!==d&&(a[d]=f,delete a[c]),g=m.cssHooks[d],g&&"expand"in g){f=g.expand(f),delete a[d];for(c in f)c in a||(a[c]=f[c],b[c]=e)}else b[d]=e}function kc(a,b,c){var d,e,f=0,g=dc.length,h=m.Deferred().always(function(){delete i.elem}),i=function(){if(e)return!1;for(var b=$b||fc(),c=Math.max(0,j.startTime+j.duration-b),d=c/j.duration||0,f=1-d,g=0,i=j.tweens.length;i>g;g++)j.tweens[g].run(f);return h.notifyWith(a,[j,f,c]),1>f&&i?c:(h.resolveWith(a,[j]),!1)},j=h.promise({elem:a,props:m.extend({},b),opts:m.extend(!0,{specialEasing:{}},c),originalProperties:b,originalOptions:c,startTime:$b||fc(),duration:c.duration,tweens:[],createTween:function(b,c){var d=m.Tween(a,j.opts,b,c,j.opts.specialEasing[b]||j.opts.easing);return j.tweens.push(d),d},stop:function(b){var c=0,d=b?j.tweens.length:0;if(e)return this;for(e=!0;d>c;c++)j.tweens[c].run(1);return b?h.resolveWith(a,[j,b]):h.rejectWith(a,[j,b]),this}}),k=j.props;for(jc(k,j.opts.specialEasing);g>f;f++)if(d=dc[f].call(j,a,k,j.opts))return d;return m.map(k,hc,j),m.isFunction(j.opts.start)&&j.opts.start.call(a,j),m.fx.timer(m.extend(i,{elem:a,anim:j,queue:j.opts.queue})),j.progress(j.opts.progress).done(j.opts.done,j.opts.complete).fail(j.opts.fail).always(j.opts.always)}function Lc(a){return function(b,c){"string"!=typeof b&&(c=b,b="*");var d,e=0,f=b.toLowerCase().match(E)||[];if(m.isFunction(c))for(;d=f[e++];)"+"===d.charAt(0)?(d=d.slice(1)||"*",(a[d]=a[d]||[]).unshift(c)):(a[d]=a[d]||[]).push(c)}}function Mc(a,b,c,d){function g(h){var i;return e[h]=!0,m.each(a[h]||[],function(a,h){var j=h(b,c,d);return"string"!=typeof j||f||e[j]?f?!(i=j):void 0:(b.dataTypes.unshift(j),g(j),!1)}),i}var e={},f=a===Ic;return g(b.dataTypes[0])||!e["*"]&&g("*")}function Nc(a,b){var c,d,e=m.ajaxSettings.flatOptions||{};for(d in b)void 0!==b[d]&&((e[d]?a:c||(c={}))[d]=b[d]);return c&&m.extend(!0,a,c),a}function Oc(a,b,c){for(var d,e,f,g,h=a.contents,i=a.dataTypes;"*"===i[0];)i.shift(),void 0===e&&(e=a.mimeType||b.getResponseHeader("Content-Type"));if(e)for(g in h)if(h[g]&&h[g].test(e)){i.unshift(g);break}if(i[0]in c)f=i[0];else{for(g in c){if(!i[0]||a.converters[g+" "+i[0]]){f=g;break}d||(d=g)}f=f||d}return f?(f!==i[0]&&i.unshift(f),c[f]):void 0}function Pc(a,b,c,d){var e,f,g,h,i,j={},k=a.dataTypes.slice();if(k[1])for(g in a.converters)j[g.toLowerCase()]=a.converters[g];for(f=k.shift();f;)if(a.responseFields[f]&&(c[a.responseFields[f]]=b),!i&&d&&a.dataFilter&&(b=a.dataFilter(b,a.dataType)),i=f,f=k.shift())if("*"===f)f=i;else if("*"!==i&&i!==f){if(g=j[i+" "+f]||j["* "+f],!g)for(e in j)if(h=e.split(" "),h[1]===f&&(g=j[i+" "+h[0]]||j["* "+h[0]])){g===!0?g=j[e]:j[e]!==!0&&(f=h[0],k.unshift(h[1]));break}if(g!==!0)if(g&&a["throws"])b=g(b);else try{b=g(b)}catch(l){return{state:"parsererror",error:g?l:"No conversion from "+i+" to "+f}}}return{state:"success",data:b}}function Vc(a,b,c,d){var e;if(m.isArray(b))m.each(b,function(b,e){c||Rc.test(a)?d(a,e):Vc(a+"["+("object"==typeof e?b:"")+"]",e,c,d)});else if(c||"object"!==m.type(b))d(a,b);else for(e in b)Vc(a+"["+e+"]",b[e],c,d)}function Zc(){try{return new a.XMLHttpRequest}catch(b){}}function $c(){try{return new a.ActiveXObject("Microsoft.XMLHTTP")}catch(b){}}function dd(a){return m.isWindow(a)?a:9===a.nodeType?a.defaultView||a.parentWindow:!1}var c=[],d=c.slice,e=c.concat,f=c.push,g=c.indexOf,h={},i=h.toString,j=h.hasOwnProperty,k={},l="1.11.1",m=function(a,b){return new m.fn.init(a,b)},n=/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,o=/^-ms-/,p=/-([\da-z])/gi,q=function(a,b){return b.toUpperCase()};m.fn=m.prototype={jquery:l,constructor:m,selector:"",length:0,toArray:function(){return d.call(this)},get:function(a){return null!=a?0>a?this[a+this.length]:this[a]:d.call(this)},pushStack:function(a){var b=m.merge(this.constructor(),a);return b.prevObject=this,b.context=this.context,b},each:function(a,b){return m.each(this,a,b)},map:function(a){return this.pushStack(m.map(this,function(b,c){return a.call(b,c,b)}))},slice:function(){return this.pushStack(d.apply(this,arguments))},first:function(){return this.eq(0)},last:function(){return this.eq(-1)},eq:function(a){var b=this.length,c=+a+(0>a?b:0);return this.pushStack(c>=0&&b>c?[this[c]]:[])},end:function(){return this.prevObject||this.constructor(null)},push:f,sort:c.sort,splice:c.splice},m.extend=m.fn.extend=function(){var a,b,c,d,e,f,g=arguments[0]||{},h=1,i=arguments.length,j=!1;for("boolean"==typeof g&&(j=g,g=arguments[h]||{},h++),"object"==typeof g||m.isFunction(g)||(g={}),h===i&&(g=this,h--);i>h;h++)if(null!=(e=arguments[h]))for(d in e)a=g[d],c=e[d],g!==c&&(j&&c&&(m.isPlainObject(c)||(b=m.isArray(c)))?(b?(b=!1,f=a&&m.isArray(a)?a:[]):f=a&&m.isPlainObject(a)?a:{},g[d]=m.extend(j,f,c)):void 0!==c&&(g[d]=c));return g},m.extend({expando:"jQuery"+(l+Math.random()).replace(/\D/g,""),isReady:!0,error:function(a){throw new Error(a)},noop:function(){},isFunction:function(a){return"function"===m.type(a)},isArray:Array.isArray||function(a){return"array"===m.type(a)},isWindow:function(a){return null!=a&&a==a.window},isNumeric:function(a){return!m.isArray(a)&&a-parseFloat(a)>=0},isEmptyObject:function(a){var b;for(b in a)return!1;return!0},isPlainObject:function(a){var b;if(!a||"object"!==m.type(a)||a.nodeType||m.isWindow(a))return!1;try{if(a.constructor&&!j.call(a,"constructor")&&!j.call(a.constructor.prototype,"isPrototypeOf"))return!1}catch(c){return!1}if(k.ownLast)for(b in a)return j.call(a,b);for(b in a);return void 0===b||j.call(a,b)},type:function(a){return null==a?a+"":"object"==typeof a||"function"==typeof a?h[i.call(a)]||"object":typeof a},globalEval:function(b){b&&m.trim(b)&&(a.execScript||function(b){a.eval.call(a,b)})(b)},camelCase:function(a){return a.replace(o,"ms-").replace(p,q)},nodeName:function(a,b){return a.nodeName&&a.nodeName.toLowerCase()===b.toLowerCase()},each:function(a,b,c){var d,e=0,f=a.length,g=r(a);if(c){if(g)for(;f>e&&(d=b.apply(a[e],c),d!==!1);e++);else for(e in a)if(d=b.apply(a[e],c),d===!1)break}else if(g)for(;f>e&&(d=b.call(a[e],e,a[e]),d!==!1);e++);else for(e in a)if(d=b.call(a[e],e,a[e]),d===!1)break;return a},trim:function(a){return null==a?"":(a+"").replace(n,"")},makeArray:function(a,b){var c=b||[];return null!=a&&(r(Object(a))?m.merge(c,"string"==typeof a?[a]:a):f.call(c,a)),c},inArray:function(a,b,c){var d;if(b){if(g)return g.call(b,a,c);for(d=b.length,c=c?0>c?Math.max(0,d+c):c:0;d>c;c++)if(c in b&&b[c]===a)return c}return-1},merge:function(a,b){for(var c=+b.length,d=0,e=a.length;c>d;)a[e++]=b[d++];if(c!==c)for(;void 0!==b[d];)a[e++]=b[d++];return a.length=e,a},grep:function(a,b,c){for(var d,e=[],f=0,g=a.length,h=!c;g>f;f++)d=!b(a[f],f),d!==h&&e.push(a[f]);return e},map:function(a,b,c){var d,f=0,g=a.length,h=r(a),i=[];if(h)for(;g>f;f++)d=b(a[f],f,c),null!=d&&i.push(d);else for(f in a)d=b(a[f],f,c),null!=d&&i.push(d);return e.apply([],i)},guid:1,proxy:function(a,b){var c,e,f;return"string"==typeof b&&(f=a[b],b=a,a=f),m.isFunction(a)?(c=d.call(arguments,2),e=function(){return a.apply(b||this,c.concat(d.call(arguments)))},e.guid=a.guid=a.guid||m.guid++,e):void 0},now:function(){return+new Date},support:k}),m.each("Boolean Number String Function Array Date RegExp Object Error".split(" "),function(a,b){h["[object "+b+"]"]=b.toLowerCase()});var s=function(a){function fb(a,b,d,e){var f,h,j,k,l,o,r,s,w,x;if((b?b.ownerDocument||b:v)!==n&&m(b),b=b||n,d=d||[],!a||"string"!=typeof a)return d;
