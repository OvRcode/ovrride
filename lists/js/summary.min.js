...
r===!0&&window.location.reload()})}),Number.prototype.pad=function(size){for(var s=String(this);s.length<(size||2);)s="0"+s;return s},$(function(){parseData(),jQuery.isEmptyObject(pickups)||outputPickups(),""!==tripData.keys()&&outputPackages()});