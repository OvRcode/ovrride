...
e.setFilters=function(b,a,c){b=l(b);var e=b.length?b[0].config:{},e=e&&e.$filters?e.$filters.each(function(b,c){l(c).find(".tablesorter-filter").val(a[b]||"")}).trigger("change.tsfilter")||!1:!1;c&&b.trigger("search",[a,!1]);return!!e};
e.addWidget({id:"stickyHeaders",priority:60,options:{stickyHeaders:"",stickyHeaders_offset:0,stickyHeaders_cloneId:"-sticky",stickyHeaders_addResizeEvent:!0,stickyHeaders_includeCaption:!0,stickyHeaders_zIndex:2},format:function(b,a,c){if(!a.$table.hasClass("hasStickyHeaders")){var f, d=a.$table,g=l(window),h=d.children("thead:first"),p=h.children("tr").not(".sticky-false").children(),q=d.find("tfoot"),m=isNaN(c.stickyHeaders_offset)?l(c.stickyHeaders_offset):"",k=m.length?m.height()||0:parseInt(c.stickyHeaders_offset,10)||0,n=c.$sticky=d.clone().addClass("containsStickyHeaders").css({position:"fixed",margin:0,top:k,visibility:"hidden",zIndex:c.stickyHeaders_zIndex?c.stickyHeaders_zIndex:2}),u=n.children("thead:first").addClass("tablesorter-stickyHeader "+c.stickyHeaders),r,w= "",v=0,x=!1,A=function(){k=m.length?m.height()||0:parseInt(c.stickyHeaders_offset,10)||0;v=0;"collapse"===d.css("border-collapse")||/(webkit|msie)/i.test(navigator.userAgent)||(v=2*parseInt(p.eq(0).css("border-left-width"),10));n.css({left:h.offset().left-g.scrollLeft()-v,width:d.width()});r.filter(":visible").each(function(a){a=p.filter(":visible").eq(a);l(this).css({width:a.width()-v,height:a.height()}).find(".tablesorter-header-inner").width(a.find(".tablesorter-header-inner").width())})};n.attr("id")&& (n[0].id+=c.stickyHeaders_cloneId);n.find("thead:gt(0), tr.sticky-false, tbody, tfoot").remove();c.stickyHeaders_includeCaption||n.find("caption").remove();r=u.children().children();n.css({height:0,width:0,padding:0,margin:0,border:0});r.find(".tablesorter-resizer").remove();d.addClass("hasStickyHeaders").bind("sortEnd.tsSticky",function(){p.filter(":visible").each(function(b){f=r.filter(":visible").eq(b).attr("class",l(this).attr("class")).removeClass(e.css.processing+" "+a.cssProcessing);a.cssIcon&& f.find("."+e.css.icon).attr("class",l(this).find("."+e.css.icon).attr("class"))})}).bind("pagerComplete.tsSticky",function(){A()});p.find(a.selectorSort).add(a.$headers.filter(a.selectorSort)).each(function(b){var c=l(this);b=u.children("tr.tablesorter-headerRow").children().eq(b).bind("mouseup",function(a){c.trigger(a,!0)});a.cancelSelection&&b.attr("unselectable","on").bind("selectstart",!1).css({"user-select":"none",MozUserSelect:"none"})});d.after(n);g.bind("scroll.tsSticky resize.tsSticky",function(a){if(d.is(":visible")){var b= d.offset(),e=c.stickyHeaders_includeCaption?0:d.find("caption").outerHeight(!0),e=g.scrollTop()+k-e,f=d.height()-(n.height()+(q.height()||0)),b=e>b.top&&e<b.top+f?"visible":"hidden";n.removeClass("tablesorter-sticky-visible tablesorter-sticky-hidden").addClass("tablesorter-sticky-"+b).css({left:h.offset().left-g.scrollLeft()-v,visibility:b});if(b!==w||"resize"===a.type)A(),w=b}});c.stickyHeaders_addResizeEvent&&e.addHeaderResizeEvent(b);d.bind("filterEnd",function(){x||u.find(".tablesorter-filter-row").children().each(function(b){l(this).find(".tablesorter-filter").val(a.$filters.find(".tablesorter-filter").eq(b).val())})}); r.find(".tablesorter-filter").bind("keyup search change",function(b){if(!(32>b.which&&8!==b.which||37<=b.which&&40>=b.which)){x=!0;b=l(this);var d=b.attr("data-column");a.$filters.find(".tablesorter-filter").eq(d).val(b.val()).trigger("search");setTimeout(function(){x=!1},c.filter_searchDelay)}});d.trigger("stickyHeadersInit")}},remove:function(b,a,c){a.$table.removeClass("hasStickyHeaders").unbind("sortEnd.tsSticky pagerComplete.tsSticky").find(".tablesorter-stickyHeader").remove();c.$sticky&&c.$sticky.length&& c.$sticky.remove();l(".hasStickyHeaders").length||l(window).unbind("scroll.tsSticky resize.tsSticky");e.addHeaderResizeEvent(b,!1)}});
e.addWidget({id:"resizable",priority:40,options:{resizable:!0,resizable_addLastColumn:!1},format:function(b,a,c){if(!a.$table.hasClass("hasResizable")){a.$table.addClass("hasResizable");var f,d,g,h,p={},q=a.$table,m=0,k=null,n=null,u=20>Math.abs(q.parent().width()-q.width()),r=function(){e.storage&&k&&(p[k.index()]=k.width(),p[n.index()]=n.width(),k.width(p[k.index()]), n.width(p[n.index()]),!1!==c.resizable&&e.storage(b,"tablesorter-resizable",p));m=0;k=n=null;l(window).trigger("resize")};if(p=e.storage&&!1!==c.resizable?e.storage(b,"tablesorter-resizable"):{})for(h in p)!isNaN(h)&&h<a.$headers.length&&a.$headers.eq(h).width(p[h]);f=q.children("thead:first").children("tr");f.children().each(function(){var b;b=l(this);h=b.attr("data-column");b="false"===e.getData(b,a.headers[h],"resizable");f.children().filter('[data-column="'+h+'"]')[b?"addClass":"removeClass"]("resizable-false")}); f.each(function(){g=l(this).children().not(".resizable-false");l(this).find(".tablesorter-wrapper").length||g.wrapInner('<div class="tablesorter-wrapper" style="position:relative;height:100%;width:100%"></div>');c.resizable_addLastColumn||(g=g.slice(0,-1));d=d?d.add(g):g});d.each(function(){var a=l(this),b=parseInt(a.css("padding-right"),10)+10;a.find(".tablesorter-wrapper").append('<div class="tablesorter-resizer" style="cursor:w-resize;position:absolute;z-index:1;right:-'+b+'px;top:0;height:100%;width:20px;"></div>')}).bind("mousemove.tsresize", function(a){if(0!==m&&k){var b=a.pageX-m,c=k.width();k.width(c+b);k.width()!==c&&u&&n.width(n.width()-b);m=a.pageX}}).bind("mouseup.tsresize",function(){r()}).find(".tablesorter-resizer,.tablesorter-resizer-grip").bind("mousedown",function(b){k=l(b.target).closest("th");var c=a.$headers.filter('[data-column="'+k.attr("data-column")+'"]');1<c.length&&(k=k.add(c));n=b.shiftKey?k.parent().find("th").not(".resizable-false").filter(":last"):k.nextAll(":not(.resizable-false)").eq(0);m=b.pageX});q.find("thead:first").bind("mouseup.tsresize mouseleave.tsresize", function(){r()}).bind("contextmenu.tsresize",function(){e.resizableReset(b);var a=l.isEmptyObject?l.isEmptyObject(p):!0;p={};return a})}},remove:function(b,a){a.$table.removeClass("hasResizable").children("thead").unbind("mouseup.tsresize mouseleave.tsresize contextmenu.tsresize").children("tr").children().unbind("mousemove.tsresize mouseup.tsresize").find(".tablesorter-resizer,.tablesorter-resizer-grip").remove();e.resizableReset(b)}});
e.resizableReset=function(b){b.config.$headers.not(".resizable-false").css("width", "");e.storage&&e.storage(b,"tablesorter-resizable",{})};
e.addWidget({id:"saveSort",priority:20,options:{saveSort:!0},init:function(b,a,c,e){a.format(b,c,e,!0)},format:function(b,a,c,f){var d,g=a.$table;c=!1!==c.saveSort;var h={sortList:a.sortList};a.debug&&(d=new Date);g.hasClass("hasSaveSort")?c&&b.hasInitialized&&e.storage&&(e.storage(b,"tablesorter-savesort",h),a.debug&&e.benchmark("saveSort widget: Saving last sort: "+a.sortList,d)):(g.addClass("hasSaveSort"),h="",e.storage&&(h=(c=e.storage(b, "tablesorter-savesort"))&&c.hasOwnProperty("sortList")&&l.isArray(c.sortList)?c.sortList:"",a.debug&&e.benchmark('saveSort: Last sort loaded: "'+h+'"',d),g.bind("saveSortReset",function(a){a.stopPropagation();e.storage(b,"tablesorter-savesort","")})),f&&h&&0<h.length?a.sortList=h:b.hasInitialized&&h&&0<h.length&&g.trigger("sorton",[h]))},remove:function(b){e.storage&&e.storage(b,"tablesorter-savesort","")}})
})(jQuery);
