<?php
/**
 * Template Name: No-Title + Sidebar + Chapman + Test
 *
	...
	<div id="primary" class="site-content row clearfix" role="main">
         ...
         <div class="col grid_3_of_12 feedbar">
            ...
            <div class="col grid_12_of_12" style="margin:0px;">
                ...
                <a href="/destinations/hunter-mt/"><img style="float: left; margin: 0px 4px 0px 0px;" alt="" src="<?php echo $img_path;?>/images/destination-imgs/hunter.png">Hunter MT</a><br>
                <a href="/destinations/windham-mt/"><img style="float: left; margin: 0px 4px 0px 0px;" alt="" src="<?php echo $img_path;?>/images/destination-imgs/windham.png">Windham MT</a>
                </div>
                ...
                <a href="/destinations/camelback/"><img style="float: left; margin: 0px 4px 0px 0px;" alt="" src="<?php echo $img_path;?>/images/destination-imgs/camelback.png">Camelback</a>
                </div>
                ...
                <a href="/destinations/stratton/"><img style="float: left; margin: 0px 4px 0px 0px;" alt="" src="<?php echo $img_path;?>/images/destination-imgs/stratton.png">Stratton</a><br>
                <a href="/destinations/mount-snow/"><img style="float: left; margin: 0px 4px 0px 0px;" alt="" src="<?php echo $img_path;?>/images/destination-imgs/mount-snow.png">Mount Snow</a><br>
                <a href="/destinations/killington/"><img style="float: left; margin: 0px 4px 0px 0px;" alt="" src="<?php echo $img_path;?>/images/destination-imgs/killington.png">Killington</a><br>
                <a href="/destinations/stowe/"><img style="float: left; margin: 0px 4px 0px 0px;" alt="" src="<?php echo $img_path;?>/images/destination-imgs/stowe.png">Stowe</a><br>
                <a href="/destinations/sugarbush/"><img style="float: left; margin: 0px 4px 0px 0px;" alt="" src="<?php echo $img_path;?>/images/destination-imgs/sugarbush.png">Sugarbush</a>
                </div>
                ...
                <a href="/destinations/lake-tahoe/"><img style="float: left; margin: 0px 4px 0px 0px;" alt="" src="<?php echo $img_path;?>/images/destination-imgs/tahoe.png">Lake Tahoe</a><br>
                <a href="/destinations/breckenridge/"><img style="float: left; margin: 0px 4px 0px 0px;" alt="" src="<?php echo $img_path;?>/images/destination-imgs/breck.png">Breckenridge</a><br>
                <a href="/destinations/snowbird/"><img style="float: left; margin: 0px 4px 0px 0px;" alt="" src="<?php echo $img_path;?>/images/destination-imgs/snowbird.png">Snowbird</a>
                </div>
                ...
                <a href="/destinations/north-chile/"><img style="float: left; margin: 0px 4px 0px 0px;" alt="" src="<?php echo $img_path;?>/images/destination-imgs/chile.png">North Chile</a><br>
                <a href="/destinations/south-chile/"><img style="float: left; margin: 0px 4px 0px 0px;" alt="" src="<?php echo $img_path;?>/images/destination-imgs/chile.png">South Chile</a><br>
                <a href="/destinations/north-argentina/"><img style="float: left; margin: 0px 4px 0px 0px;" alt="" src="<?php echo $img_path;?>/images/destination-imgs/argentina.png">North Argentina</a><br>
                <a href="/destinations/south-argentina/"><img style="float: left; margin: 0px 4px 0px 0px;" alt="" src="<?php echo $img_path;?>/images/destination-imgs/argentina.png">South Argentina</a>
                </div>
                ...
                <a href="/destinations/whistler/"><img style="float: left; margin: 0px 4px 0px 0px;" alt="" src="<?php echo $img_path;?>/images/destination-imgs/whistler.png">Whistler</a>
                </div>
                ...
                <a href="/destinations/japan/"><img style="float: left; margin: 0px 4px 0px 0px;" alt="" src="<?php echo $img_path;?>/images/destination-imgs/japan-icon.png">Japan</a>
                </div>
                </div>
            </div>
        </div>
