<?php
/*
* Plugin Name: OvRride Small Ad widget
* Description:  Small tile widget to display an ad.
* Author: Mike Barnard
* Author URI: http://github.com/barnardm
* Version: 0.1.0
* License: MIT License
*/
class ovr_small_ad_widget extends WP_Widget {
  function __construct() {
    ...
    // Widget description
    array( 'description' => 'Small tile widget to display an ad' )
    );
  }
  public function form($instance) {
    ...
    echo <<<WIDGETADMIN
      <p>
        ...
        <button class="small_ad_upload_image_button button button-primary">Upload Ad Image</button>
      </p>
      <p>
      ...
      <div class="ovr_small_ad_widget">
        <div class="ovr_small_ad_inner">
          <a href="{$instance['link']}" target="_blank">
            <img class="ovr_small_ad_img" src="{$instance['ad']}">
          </a>
        </div>
      </div>
WIDGET;
