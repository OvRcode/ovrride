	...
	_createClass(UI, [{
		...
		value: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(_svg.SVGSymbols, null)
			);
		}
	}]);
...
var InlineEditor = function (_Component) {
	...
	_createClass(InlineEditor, [{
		...
		value: function initEditable(e, module) {
			...
			if (preview) {
				var isParent = module.parents('.fl-node-' + preview.nodeId).length;
...
var SVGSymbols = exports.SVGSymbols = function SVGSymbols(props) {
    return _react2.default.createElement(
        _react.Fragment,
        null,
        _react2.default.createElement(
            'svg',
            { id: 'fl-symbol-container', version: '1.1', xmlns: 'http://www.w3.org/2000/svg' },
            _react2.default.createElement(
                'symbol',
                { id: 'fl-down-caret', viewBox: '0 0 11 6' },
                _react2.default.createElement('polygon', { points: '0 0 2.05697559 0 5.49235478 3.74058411 8.93443824 0 11 0 5.5 6' })
            )
        )
    );
};
