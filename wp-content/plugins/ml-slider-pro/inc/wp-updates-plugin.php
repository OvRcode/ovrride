...
if( !class_exists('WPUpdatesPluginUpdater_136') ) {
    class WPUpdatesPluginUpdater_136 {
        ...
        function check_for_update( $transient ) {
            ...
            // ignore update checks when $transient is incorrectly/incompletely passed from other non-wordpress.org plugins
            if( ! isset( $transient->checked[$this->plugin_path] ) ) return $transient;
