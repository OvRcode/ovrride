...
class WC_Product_Addons_Field_File_Upload extends WC_Product_Addons_Field {
	...
	public function get_cart_item_data() {
		...
		} elseif ( isset( $this->value[ sanitize_text_field( $this->addon['name'] ) ] ) ) {
			$this_data['value']   = $this->value[ sanitize_text_field( $this->addon['name'] ) ];
			$this_data['display'] = basename( $this->value[ sanitize_text_field( $this->addon['name'] ) ] );
			$cart_item_data[]     = $this_data;
		}
