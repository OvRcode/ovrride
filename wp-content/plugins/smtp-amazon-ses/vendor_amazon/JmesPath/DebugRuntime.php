...
class DebugRuntime
{
    ...
    public function __construct(callable $runtime, $output = null)
    {
        ...
        $this->lexer = new \YaySMTPAmazonSES\Aws3\JmesPath\Lexer();
        $this->parser = new \YaySMTPAmazonSES\Aws3\JmesPath\Parser($this->lexer);
    }
    ...
    {
        $lexer = new \YaySMTPAmazonSES\Aws3\JmesPath\Lexer();
    ...
    {
        $parser = new \YaySMTPAmazonSES\Aws3\JmesPath\Parser();
