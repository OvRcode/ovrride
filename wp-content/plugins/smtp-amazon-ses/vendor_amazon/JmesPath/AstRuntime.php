...
class AstRuntime
{
    ...
    public function __construct(\YaySMTPAmazonSES\Aws3\JmesPath\Parser $parser = null, callable $fnDispatcher = null)
    {
        $fnDispatcher = $fnDispatcher ?: \YaySMTPAmazonSES\Aws3\JmesPath\FnDispatcher::getInstance();
        $this->interpreter = new \YaySMTPAmazonSES\Aws3\JmesPath\TreeInterpreter($fnDispatcher);
        $this->parser = $parser ?: new \YaySMTPAmazonSES\Aws3\JmesPath\Parser();
    }
    /**
