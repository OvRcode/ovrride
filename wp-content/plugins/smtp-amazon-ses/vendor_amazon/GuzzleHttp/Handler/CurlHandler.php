...
class CurlHandler
{
    ...
    {
        $this->factory = isset($options['handle_factory']) ? $options['handle_factory'] : new \YaySMTPAmazonSES\Aws3\GuzzleHttp\Handler\CurlFactory(3);
    }
    public function __invoke(\YaySMTPAmazonSES\Aws3\Psr\Http\Message\RequestInterface $request, array $options)
    {
        ...
        return \YaySMTPAmazonSES\Aws3\GuzzleHttp\Handler\CurlFactory::finish($this, $easy, $this->factory);
    }
}
