 ...
 */
class FnStream implements \YaySMTPAmazonSES\Aws3\Psr\Http\Message\StreamInterface
{
    /** @var array */
    private $methods;
     ...
     * @return FnStream
     */
    public static function decorate(\YaySMTPAmazonSES\Aws3\Psr\Http\Message\StreamInterface $stream, array $methods)
    {
