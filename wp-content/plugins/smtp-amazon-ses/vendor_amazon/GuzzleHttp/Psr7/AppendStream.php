 ...
 */
class AppendStream implements \YaySMTPAmazonSES\Aws3\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function addStream(\YaySMTPAmazonSES\Aws3\Psr\Http\Message\StreamInterface $stream)
    {
