 ...
 */
class LimitStream implements \YaySMTPAmazonSES\Aws3\Psr\Http\Message\StreamInterface {
   ...
   */
  public function __construct(\YaySMTPAmazonSES\Aws3\Psr\Http\Message\StreamInterface $stream, $limit = -1, $offset = 0) {
    $this->stream = $stream;
    $this->setLimit($limit);
