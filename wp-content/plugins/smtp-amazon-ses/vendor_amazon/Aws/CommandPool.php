 ...
 */
class CommandPool implements \YaySMTPAmazonSES\Aws3\GuzzleHttp\Promise\PromisorInterface
{
    /** @var EachPromise */
    private $each;
    /**
     ...
     */
    public function __construct(\YaySMTPAmazonSES\Aws3\Aws\AwsClientInterface $client, $commands, array $config = [])
    {
        ...
        $this->each = new \YaySMTPAmazonSES\Aws3\GuzzleHttp\Promise\EachPromise($mapFn($commands), $config);
    }
    /**
     ...
     */
    public static function batch(\YaySMTPAmazonSES\Aws3\Aws\AwsClientInterface $client, $commands, array $config = [])
    {
        $results = [];
