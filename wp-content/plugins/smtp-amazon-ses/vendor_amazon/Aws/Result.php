...
use YaySMTPAmazonSES\Aws3\JmesPath\Env as JmesPath;
/**
 * AWS result.
 */
class Result implements \YaySMTPAmazonSES\Aws3\Aws\ResultInterface
{
    use HasDataTrait;
    ...
    {
        return \YaySMTPAmazonSES\Aws3\JmesPath\Env::search($expression, $this->toArray());
    }
