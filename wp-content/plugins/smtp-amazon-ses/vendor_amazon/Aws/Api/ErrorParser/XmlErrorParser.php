...
class XmlErrorParser
{
    ...
    public function __invoke(\YaySMTPAmazonSES\Aws3\Psr\Http\Message\ResponseInterface $response)
    {
    ...
    private function parseHeaders(\YaySMTPAmazonSES\Aws3\Psr\Http\Message\ResponseInterface $response, array &$data)
    {
