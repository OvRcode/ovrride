...
use YaySMTPAmazonSES\Aws3\Aws\Api\Parser\QueryParser;
use YaySMTPAmazonSES\Aws3\Aws\Api\Serializer\Ec2ParamBuilder;
use YaySMTPAmazonSES\Aws3\Aws\Api\Serializer\QuerySerializer;

/**
 * Represents a web service API model.
 */
class Service extends \YaySMTPAmazonSES\Aws3\Aws\Api\AbstractModel {
  /** @var callable */
  private $apiProvider;
  /** @var string */
  private $serviceName;
  ...
  public function __construct(array $definition, callable $provider) {
    ...
    parent::__construct($definition, new \YaySMTPAmazonSES\Aws3\Aws\Api\ShapeMap($definition['shapes']));
   ...
   */
  public static function createSerializer(\YaySMTPAmazonSES\Aws3\Aws\Api\Service $api, $endpoint) {
    static $mapping = ['json' => 'YaySMTPAmazonSES\\Aws3\\Aws\\Api\\Serializer\\JsonRpcSerializer', 'query' => 'YaySMTPAmazonSES\\Aws3\\Aws\\Api\\Serializer\\QuerySerializer', 'rest-json' => 'YaySMTPAmazonSES\\Aws3\\Aws\\Api\\Serializer\\RestJsonSerializer', 'rest-xml' => 'YaySMTPAmazonSES\\Aws3\\Aws\\Api\\Serializer\\RestXmlSerializer'];
    $proto = $api->getProtocol();
    if (isset($mapping[$proto])) {
      return new $mapping[$proto]($api, $endpoint);
    }
    if ($proto == 'ec2') {
      return new \YaySMTPAmazonSES\Aws3\Aws\Api\Serializer\QuerySerializer($api, $endpoint, new \YaySMTPAmazonSES\Aws3\Aws\Api\Serializer\Ec2ParamBuilder());
    }
  ...
  public static function createErrorParser($protocol) {
    static $mapping = ['json' => 'YaySMTPAmazonSES\\Aws3\\Aws\\Api\\ErrorParser\\JsonRpcErrorParser', 'query' => 'YaySMTPAmazonSES\\Aws3\\Aws\\Api\\ErrorParser\\XmlErrorParser', 'rest-json' => 'YaySMTPAmazonSES\\Aws3\\Aws\\Api\\ErrorParser\\RestJsonErrorParser', 'rest-xml' => 'YaySMTPAmazonSES\\Aws3\\Aws\\Api\\ErrorParser\\XmlErrorParser', 'ec2' => 'YaySMTPAmazonSES\\Aws3\\Aws\\Api\\ErrorParser\\XmlErrorParser'];
   ...
   * @throws \UnexpectedValueException
   */
  public static function createParser(\YaySMTPAmazonSES\Aws3\Aws\Api\Service $api) {
    static $mapping = ['json' => 'YaySMTPAmazonSES\\Aws3\\Aws\\Api\\Parser\\JsonRpcParser', 'query' => 'YaySMTPAmazonSES\\Aws3\\Aws\\Api\\Parser\\QueryParser', 'rest-json' => 'YaySMTPAmazonSES\\Aws3\\Aws\\Api\\Parser\\RestJsonParser', 'rest-xml' => 'YaySMTPAmazonSES\\Aws3\\Aws\\Api\\Parser\\RestXmlParser'];
    $proto = $api->getProtocol();
    if (isset($mapping[$proto])) {
      return new $mapping[$proto]($api);
    }
    if ($proto == 'ec2') {
      return new \YaySMTPAmazonSES\Aws3\Aws\Api\Parser\QueryParser($api, null, false);
    }
    throw new \UnexpectedValueException('Unknown protocol: ' . $api->getProtocol());
  }
  /**
  ...
  public function getOperation($name) {
    if (!isset($this->operations[$name])) {
      ...
      $this->operations[$name] = new \YaySMTPAmazonSES\Aws3\Aws\Api\Operation($this->definition['operations'][$name], $this->shapeMap);
    }
