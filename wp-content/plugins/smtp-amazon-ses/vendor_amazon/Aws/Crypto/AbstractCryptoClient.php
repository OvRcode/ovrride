...
use YaySMTPAmazonSES\Aws3\Aws\Crypto\Cipher\CipherMethod;
use YaySMTPAmazonSES\Aws3\Aws\Crypto\Cipher\Cbc;
...
abstract class AbstractCryptoClient
{
     ...
     * @internal
     */
    public abstract function encrypt(\YaySMTPAmazonSES\Aws3\GuzzleHttp\Psr7\Stream $plaintext, array $cipherOptions, \YaySMTPAmazonSES\Aws3\Aws\Crypto\MaterialsProvider $provider, \YaySMTPAmazonSES\Aws3\Aws\Crypto\MetadataEnvelope $envelope);
    /**
     ...
     * @internal
     */
    public abstract function decrypt($cipherText, \YaySMTPAmazonSES\Aws3\Aws\Crypto\MaterialsProvider $provider, \YaySMTPAmazonSES\Aws3\Aws\Crypto\MetadataEnvelope $envelope, array $cipherOptions = []);
}
