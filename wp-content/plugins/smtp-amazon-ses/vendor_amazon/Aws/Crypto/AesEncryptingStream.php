 ...
 */
class AesEncryptingStream implements \YaySMTPAmazonSES\Aws3\Aws\Crypto\AesStreamInterface
{
    const BLOCK_SIZE = 16;
    // 128 bits
     ...
     */
    public function __construct(\YaySMTPAmazonSES\Aws3\Psr\Http\Message\StreamInterface $plainText, $key, \YaySMTPAmazonSES\Aws3\Aws\Crypto\Cipher\CipherMethod $cipherMethod)
    {
