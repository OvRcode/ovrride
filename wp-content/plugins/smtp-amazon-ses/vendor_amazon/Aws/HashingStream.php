 ...
 */
class HashingStream implements \YaySMTPAmazonSES\Aws3\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function __construct(\YaySMTPAmazonSES\Aws3\Psr\Http\Message\StreamInterface $stream, \YaySMTPAmazonSES\Aws3\Aws\HashInterface $hash, callable $onComplete = null)
    {
        $this->stream = $stream;
        $this->hash = $hash;
