...
<div class="dobCheck">
  ...
  <br />
  <?php if ( substr( $age_limit, -1 ) != "+" ): ?>
    <p>Guests under <?php echo $age_label; ?> years of age are welcome to join us as long as they abide by the terms of the <a href="http://ovrride.com/ovrride-age-policy/" target="_blank"><strong>OvRride Age Policy</strong></a>, and we are aware of the underage guest.</p>
  <?php else: ?>
    <p>For this trip guests need to be at least <?php echo $age_label; ?> years of age, we are unable to accomodate guests under <?php echo $age_label; ?> years of age.</p>
  <?php endif; ?>
