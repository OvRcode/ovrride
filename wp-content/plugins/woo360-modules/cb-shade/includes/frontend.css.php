...
<?php if($settings->cb_shade_min_height) { ?>

.fl-node-<?php echo $id; ?> .cb-shade-boxes .cb-shade-box-wrapper {
    min-height: <?php echo $settings->cb_shade_min_height; ?>px;
    _height: <?php echo $settings->cb_shade_min_height; ?>px;
}
...
.fl-node-<?php echo $id; ?> .cb-shade-boxes .cb-shade-box-inner {
    padding: <?php echo $settings->hover_text_padding; ?>px;
}


.fl-node-<?php echo $id; ?> .cb-shade-boxes .cb-shade-box-wrapper .cb-shade-box-overlay {
    background: <?php echo $color_3; ?>;
    border-radius: <?php echo $settings->hover_overlay_radius; ?>px; 
    }
