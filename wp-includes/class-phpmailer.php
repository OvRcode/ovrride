...
class PHPMailer {
  ...
  */
   ...
   * by SERVER_NAME is used or '***REMOVED***.localdomain'.
   * @var string
   */
  public $Hostname          = '';
 ...
 */
  ...
  */
  ...
  /**
   * Returns the server hostname or '***REMOVED***.localdomain' if unknown.
   * @access protected
   * @return string
   */
